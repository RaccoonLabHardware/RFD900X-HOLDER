...
if os.path.exists('./Project Outputs/NC Drill/PCB.TXT'):
    shutil.copyfile('./Project Outputs/NC Drill/PCB.TXT', './PCBWay-output/nc-drill.txt')  
else:
    shutil.copyfile('./Project Outputs/NC Drill/PCB-RoundHoles.TXT', './PCBWay-output/nc-drill-RoundHoles.txt')
    shutil.copyfile('./Project Outputs/NC Drill/PCB-SlotHoles.TXT', './PCBWay-output/nc-drill-SlotHoles.txt')
...
def minFromNCDrill():
    p = './Project Outputs/NC Drill/PCB.TXT'
    if os.path.exists(p):
        p = './Project Outputs/NC Drill/PCB.TXT'
    else:
        p = './Project Outputs/NC Drill/PCB-RoundHoles.TXT'
    with open(p) as f:
        lines = f.readlines()
    for i in range(lines.__len__()):
        lines[i] = lines[i].strip()
